...
public class CameraPerspective3 : MonoBehaviour
{
    // Start is called before the first frame update
    Character3 scriptInstance = null;
    NewBehaviourScript3 scriptCantouch = null;
    ...
    void Start()
    {
        ...
        scriptInstance = tempObj.GetComponent<Character3>();
        GameObject tempObj2 = GameObject.Find("Sphere");
        scriptCantouch = tempObj2.GetComponent<NewBehaviourScript3>();
