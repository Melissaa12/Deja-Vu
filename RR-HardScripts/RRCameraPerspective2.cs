...
public class RRCameraPerspective2 : MonoBehaviour
{
    // Start is called before the first frame update
    RRCharacter2 scriptInstance = null;
    RRNewBehaviourScript2 scriptCantouch = null;
    ...
    void Start()
    {
        ...
        scriptInstance = tempObj.GetComponent<RRCharacter2>();
        GameObject tempObj2 = GameObject.Find("Sphere");
        scriptCantouch = tempObj2.GetComponent<RRNewBehaviourScript2>();
