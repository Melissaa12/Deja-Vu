...
{
    private float movementDuration = 1.1f; // the lower the faster
    ...
    Character2 script2Instance = null;
    ...
    private void Update()
    {
        ...
        script2Instance = tempObj.GetComponent<Character2>();
