...
public class TimerHard : MonoBehaviour
{
    ...
    NewBehaviourScript2 scriptInstance6 = null;
    Character2 scriptInstance5 = null;
    ...
    void Start()
    {
        ...
        scriptInstance6 = tempObj.GetComponent<NewBehaviourScript2>();
        GameObject tempObj2 = GameObject.Find("Character");
        scriptInstance5 = tempObj2.GetComponent<Character2>();
    ...
    void Update()
    {
        ...
        if (scriptInstance5.isOver == false &&  scriptInstance6.canMove == true && scriptInstance5.timerstop == false)
        {
            ...
            t += (1 / (scriptInstance6.moves123 * 1.5f)) * Time.deltaTime; // no. seconds = 1 divided by (time) 
