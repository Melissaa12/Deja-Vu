...
public class Character2 : MonoBehaviour
{
    ...
    NewBehaviourScript2 scriptInstance = null;
    CameraPerspective2 scriptInstance2 = null;
    GameoverManager2 scriptInstanceGameOver = null;
    ...
    void Update()
    {
        n = NewBehaviourScript2.m;
        if (n == 3 && flag == true)
        {
            GameObject tempObj = GameObject.Find("Sphere");
            scriptInstance = tempObj.GetComponent<NewBehaviourScript2>();
            GameObject tempObj2 = GameObject.Find("Main Camera");
            scriptInstance2 = tempObj2.GetComponent<CameraPerspective2>();
            GameObject tempObj3 = GameObject.Find("Canvas");
            scriptInstanceGameOver = tempObj3.GetComponent<GameoverManager2>();
    ...
    private void LateUpdate() //ADD in a move counter to loop
    {
        ...
        else
        {
            ...
            if (ClearMeter > Mathf.Floor(scriptInstance.moves123 - 1)) // get number of moves for that round
            {
                ...
                ScoreboardManager2.score += (int)(1) ;
