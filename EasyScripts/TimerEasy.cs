...
public class TimerEasy : MonoBehaviour
{
    ...
    NewBehaviourScript scriptInstance6 = null;
    Character scriptInstance5 = null;
    ...
    void Start()
    {
        ...
        scriptInstance6 = tempObj.GetComponent<NewBehaviourScript>();
        GameObject tempObj2 = GameObject.Find("Character");
        scriptInstance5 = tempObj2.GetComponent<Character>();
