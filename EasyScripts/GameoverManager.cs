...
public class GameoverManager : MonoBehaviour
{
    ...
    Character scriptInstance8 = null;
    TimerEasy scriptInstance7 = null;
    ...
    void Start()
    {
        ...
        scriptInstance8 = tempObj.GetComponent<Character>();
        GameObject tempObj2 = GameObject.Find("Timer");
        scriptInstance7 = tempObj2.GetComponent<TimerEasy>();
